        ...
        <>
            <div className="about">
                <div className="aboutUs">
                    ...
                    <div style={{ height: "61rem" }} className="flex flex-column items-center justify-evenly">
                        ...
                        <div className="ourTeamMain d-flex justify-content-evenly flex-column">
                            <div className="teamHeader d-flex justify-content-center align-items-center flex-column">
                                ...
                                <div className="teamDesc mb-4 col-111 flex items-center justify-center">
                                    <p style={{ width: '61%', textAlign: "center" }}>ZakatCare is powered by a dedicated team of professionals who share a passion for helping those in need. Each member brings unique skills and expertise, working together to deliver the best possible impact for our communities.</p>
                                </div>
                            </div>
